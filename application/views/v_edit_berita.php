...
<head>
    ...
    <title>Edit Berita - Admin Desa Rarongkeu</title>
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body p-4">
                        <h3 class="fw-bold mb-4 text-success"><i class="fa-solid fa-pen-to-square me-2"></i>Edit Berita</h3>
                        
                        <!-- Form update mengirim data menggunakan multipart karena ada file gambar -->
                        <?php echo form_open_multipart('admin/update_berita/' . $berita->id_berita); ?>
                            ...
                            <!-- Tambahan Input Kategori dengan Selected -->
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Kategori</label>
                                <select name="kategori" class="form-control" required>
                                    <option value="Kegiatan Desa" <?php if($berita->kategori == 'Kegiatan Desa') echo 'selected'; ?>>Kegiatan Desa</option>
                                    <option value="Kesehatan" <?php if($berita->kategori == 'Kesehatan') echo 'selected'; ?>>Kesehatan</option>
                                    <option value="Pengumuman" <?php if($berita->kategori == 'Pengumuman') echo 'selected'; ?>>Pengumuman</option>
                                    <option value="Pembangunan" <?php if($berita->kategori == 'Pembangunan') echo 'selected'; ?>>Pembangunan</option>
                                </select>
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-semibold">Isi Berita</label>
                                <textarea name="isi" class="form-control" rows="6" required><?php echo $berita->isi; ?></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-2">
                                    <?php if(!empty($berita->gambar)): ?>
                                        <img src="<?php echo base_url('assets/upload/' . $berita->gambar); ?>" alt="Preview" class="img-thumbnail" style="height: 120px;">
                                    <?php else: ?>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <a href="<?php echo site_url('admin/berita'); ?>" class="btn btn-secondary">Kembali</a>
