    ...
    <div class="container my-5">
        <div class="row g-4">
            ...
            <div class="col-md-4 col-sm-6">
                    ...
                    <div class="card shadow-none gallery-card h-100 border-0 bg-transparent">
                
                    <img src="<?php echo base_url('assets/upload/' . $g->gambar); ?>" class="card-img-top gallery-img" alt="<?php echo $g->judul; ?>">
                    <div class="card-body">
                        <span class="badge bg-secondary-subtle text-secondary mb-2 px-2 py-1 small"><?php echo $g->kategori; ?></span>
