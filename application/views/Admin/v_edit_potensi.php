...
<head>
    ...
    <title>Edit Potensi - Admin Desa Rarongkeu</title>
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body p-4">
                        <h3 class="fw-bold mb-4 text-success"><i class="fa-solid fa-pen-to-square me-2"></i>Edit Potensi Desa</h3>
                        
                        <?php echo form_open_multipart('admin/update_potensi/' . $potensi->id); ?>
                            
                            <input type="hidden" name="id" value="<?php echo $potensi->id; ?>">

                            <div class="mb-3">
                                <label class="form-label fw-semibold">Nama Potensi</label>
                                <input type="text" name="nama_potensi" class="form-control" value="<?php echo $potensi->nama_potensi; ?>" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-semibold">Kategori</label>
                                <input type="text" name="kategori" class="form-control" value="<?php echo $potensi->kategori; ?>" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-semibold">Deskripsi</label>
                                <textarea name="deskripsi" class="form-control" rows="4" required><?php echo $potensi->deskripsi; ?></textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-semibold">Foto Saat Ini</label>
                                <div class="mb-2">
                                    <?php if(!empty($potensi->foto)): ?>
                                        <img src="<?php echo base_url('assets/upload/' . $potensi->foto); ?>" alt="Preview" class="img-thumbnail" style="height: 120px;">
                                    <?php else: ?>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <a href="<?php echo site_url('admin/potensi'); ?>" class="btn btn-secondary px-4">Kembali</a>
