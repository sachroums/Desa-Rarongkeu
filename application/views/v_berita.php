...
<head>
    ...
    <title>Berita Desa - Desakita Desa Rarongkeu</title>
...
<body class="bg-light">
    ...
    <div class="container my-5">
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="card news-card h-100 bg-white">
                    <img src="<?php echo base_url('assets/upload/' . $row->gambar); ?>" class="card-img-top news-img" alt="<?php echo $row->judul; ?>">
                    <div class="card-body d-flex flex-column">
                        <div class="d-flex align-items-center text-muted small mb-2">
                            <span><i class="fa-regular fa-calendar me-1"></i> <?php echo date('d M Y', strtotime($row->tanggal)); ?></span>
                        </div>
                        <h5 class="fw-bold text-dark mb-2"><?php echo $row->judul; ?></h5>
                        <!-- Menggunakan kolom 'isi' sesuai tabel database Anda -->
                        <p class="small text-muted mb-4"><?php echo character_limiter(strip_tags($row->isi), 90); ?></p>
                        <a href="<?php echo site_url('home/detail_berita/' . $row->id_berita); ?>" class="btn btn-outline-success btn-sm mt-auto align-self-start">Baca Selengkapnya</a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled small">
                        ...
                        <li class="mb-1"><a href="#" class="text-decoration-none">Berita</a></li>
